...
Plugin for displaying a European Payment Council QR-Code for SEPA bank transfers. Enables users to initiate a bank transfer by scanning the code with their banking app.
